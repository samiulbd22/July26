...
const members = {
    ...
    serviceBill     :20,
    othersBill      :100,
    runningMonth    :"July 26",
    previousMonth   :"June-25", // new addDecember link https://grabify.link/P0IBKC
    upComingMonth   :"August 1,2026",
    runningMealRate :57,
...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"01/07/26-DBBL":500,"11/07/26-DBBL":2000,"23/07/26-Cash":500,"28/07/26-DBBL":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2516,//2937
        running_paid    :4000,
        running_meal    :25,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        payment             :{"02/07/26-Cash":3000,"10/07/26-Cash":2000},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :2867,//2514
        running_paid    :5000,
        running_meal    :37,
        // method calling
        preMonth,
    ...
    "01518924243":{
        ...
        payment             :{"08/07/26-Cash":5000,"19/07/26-Cash":2500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3943,//00
        running_paid    :7500,
        running_meal    :69,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :7245,
        previous_paid       :3500,
        previous_dining_cost:3186,
        payment             :{"15/07/26-Cash":3000,"20/07/26-Cash":3000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :10491,//9050
        running_paid    :6000,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        post_payable        :3923,
        previous_paid       :5000,
        previous_dining_cost:2360,
        payment             :{"02/07/26-Cash":500,"04/07/26-Cash":2000,"15/07/26-Cash":4500,"20/07/26-Cash":500,"31/07/26-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :5043,//4433
        running_paid    :8000,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01953722448":{
        ...
        post_payable        :2800,
        previous_paid       :5300,
        previous_dining_cost:3068,
        payment             :{"02/07/26-Cash":500,"05/07/26-Cash":500,"07/07/26-Cash":3000,
							  "09/07/26-Cash":500,"17/07/26-Cash":1000,"25/07/26-Cash":800},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :4128,
        running_paid    :6300,
        running_meal    :46,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        previous_paid       :6000,
        previous_dining_cost:1770,
        payment             :{"06/07/26-Cash":5000,"09/07/26-Cash":1000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4188,//4359
        running_paid    :6000,
        running_meal    :28,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        previous_paid       :9000,
        previous_dining_cost:1534,
        payment             :{"13/07/26-Cash":3000,"26/07/26-Cash":500},
        // running month {"02/07/26-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :17,//3488
        running_paid    :3500,
        running_meal    :34,
        // method calling
        preMonth,
    ...
    "01818334194":{
        name:"Md Mazedur Rahman",
        //join:"new",
        // pre-previous month list
        post_payable        :4000,
        previous_paid       :5200,
        previous_dining_cost:2006,
        payment             :{"02/07/26-Cash":500,"03/07/26-Cash":310,"14/07/26-Cash":2500,"18/07/26-Cash":1000,"22/07/26-Cash":2000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :4066,//0
        running_paid    :6310,
        running_meal    :45,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        payment             :{"02/07/26-Cash":500,"13/07/26-Cash":1000,"15/07/26-Cash":1000},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :0,
...
//runningMonthPayment
    if(memberNumber.length  === 11){
        if( memberNumber    === "01639523533" 
         ...
         || memberNumber    === "01537664564"   || memberNumber === "01518924243"
         ||memberNumber     ==="01818334194"    || memberNumber === "01821245430"||
            ...
            memberDiningList.innerHTML = `
                                           ...
                                           <tr>
                                                <td>${members["01518924243"].name}</td>
                                                <td>${members["01518924243"].runningDiningCost()}</td>
                                                <td>${members["01518924243"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01518924243"].runningMonth().remainDining}</td>
                                                <td>${members["01518924243"].runningMonth().diningDue}</td>
                                            </tr>
                                           <tr>
                                            ...
                                            <tr>
                                                <td>${members["01953722448"].name}</td>
                                                <td>${members["01953722448"].runningDiningCost()}</td>
                                                <td>${members["01953722448"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01953722448"].runningMonth().remainDining}</td>
                                                <td>${members["01953722448"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
                                                <td>${members["01818334194"].name}</td>
                                                <td>${members["01818334194"].runningDiningCost()}</td>
                                                <td>${members["01818334194"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01818334194"].runningMonth().remainDining}</td>
                                                <td>${members["01818334194"].runningMonth().diningDue}</td>
                                            </tr>
					                        <tr>
            ...
            if(memberNumber === '01710430501'){
                ...
                costTotalCheck.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                <th>${members["01818334194"].name}</th>
                                                <td class="payable">${members["01818334194"].totalPayable()}</td>
                                                <td class="paid-me">${members["01818334194"].running_paid}</td>
                                                <td class="dining-me">${members["01818334194"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01818334194"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th>${members["01953722448"].name}</th>
                                                <td class="payable">${members["01953722448"].totalPayable()}</td>
                                                <td class="paid-me">${members["01953722448"].running_paid}</td>
                                                <td class="dining-me">${members["01953722448"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01953722448"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
                                                <th>${members["01518924243"].name}</th>
                                                <td class="payable">${members["01518924243"].totalPayable()}</td>
                                                <td class="paid-me">${members["01518924243"].running_paid}</td>
                                                <td class="dining-me">${members["01518924243"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01518924243"].runningMonth().diningDue}</td>
                                            </tr>
                                            `;
